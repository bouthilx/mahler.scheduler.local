# -*- coding: utf-8 -*-
#
# mahler.scheduler.local documentation build configuration file.
#
...
import mahler.scheduler.local as scheduler_plugin
...
project = u'mahler.scheduler.local'
...
latex_documents = [
  (master_doc, 'mahler.scheduler.local.tex',
   u'Mahler scheduler local Documentation',
...
texinfo_documents = [
  (master_doc, 'local',
   u'Mahler scheduler local Documentation',
   author, 'local', scheduler_plugin.__descr__,
   'Miscellaneous'),
]
