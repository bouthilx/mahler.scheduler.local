#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Installation script for `mahler.scheduler.local`."""
import os
...
setup_args = dict(
    ...
    url='https://github.com/bouthilx/mahler.scheduler.local',
    packages=['mahler.scheduler.local'],
    package_dir={'': 'src'},
    include_package_data=True,
    # data_files=find_data_files(),
    entry_points={
        'Scheduler': [
            'local = mahler.scheduler.local'
            ],
        },
    install_requires=['mahler.core', 'psutil'],
